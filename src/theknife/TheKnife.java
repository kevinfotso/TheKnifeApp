...
public class TheKnife {
    ...
    private static void cercaRistorantiFlow(boolean logged, Utente u) {
        ...
        Integer pmin = parseIntOrNullPrompt("Prezzo minimo (invio per nessuno): ");
        Integer pmax = parseIntOrNullPrompt("Prezzo massimo (invio per nessuno): ");
    ...
    private static void aggiungiRistoranteFlow(Utente u) {
        ...
        int prezzo = leggiInt("Prezzo medio: ");
